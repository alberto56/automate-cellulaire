...
name: Caterloopillar
id: caterloopillar
permalink: /patterns/caterloopillar
source:
  ...
  changes: []
description: |
  A family of adjustable-speed [spaceship](/patterns/spaceship)s constructed
  ...
  underlying Caterloopillar [toolkit](/patterns/toolkit).  For technical reasons, the
